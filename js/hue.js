...
[-t4CRWOh-IS9MrAVBfrnl2yelXRQ0WrJnwI9lidh]
...
{"devicetype":"my_hue_app200568451"}
...
const user = "-t4CRWOh-IS9MrAVBfrnl2yelXRQ0WrJnwI9lidh";

// selecting light turn off and on button
const offLight = document.querySelector("#off");
const onLight = document.querySelector("#on");

// making light value turned on as default value
let lightValue = true;
